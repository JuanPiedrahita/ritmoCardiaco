-- Database generated with pgModeler (heartappQL Database Modeler).
-- pgModeler  version: 0.9.1-beta1
-- heartappQL version: 10.0
...
-- ddl-end --
ALTER TABLE public.patient OWNER TO heartapp;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.contact OWNER TO heartapp;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.heart_rate_measurement OWNER TO heartapp;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.diagnosis OWNER TO heartapp;
-- ddl-end --
